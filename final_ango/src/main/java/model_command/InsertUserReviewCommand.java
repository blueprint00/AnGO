...
public class InsertUserReviewCommand extends Command {

	private UserDAO userDAO;
	private ResponseDTO server_response;

	public InsertUserReviewCommand(UserDAO userDAO) {
	...
	public ResponseDTO doCommand(RequestDTO client_request) {
		...
		try {
			...
			e.printStackTrace();
			server_response.setResponse_msg("InsertUserReview_fail");
		}
