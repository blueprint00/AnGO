...
public class AirWeatherTask extends AsyncTask<Void, Void, String> {
    ...
    protected String doInBackground(Void... voids) {
        ...
        System.out.println("AIRWEATHER URL : " + latitude + " " + longitude);

        System.out.println("FULL CITY NAME : " + fullCityName);
        ...
        String cityName3 = fullCityName.split(", ")[3];
        String guName = "";
        ...
        try {
            ...
            for (int i = 0; i < CurrentLocationActivity.districtEngName.length; i++) {
                if (cityName1.equals(CurrentLocationActivity.districtEngName[i])) {
                    ...
                    guName = CurrentLocationActivity.districtName[i];
                } else if(cityName3.equals(CurrentLocationActivity.districtEngName[i])){
                    guName = CurrentLocationActivity.districtName[i];
                }
            ...
            for (int i = 0; i < lists.size(); i++) {
                ...
                if (list.cityName.equals(guName)) {
                    ...
                    if(80 < originalAirWeatherObject.pm10Value && originalAirWeatherObject.pm10Value <= 160)
                        str_Air = "나쁨";
                    else str_Air = "좋음";
                }
            }
