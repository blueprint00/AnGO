            ...
            if (conn.getResponseCode() == conn.HTTP_OK) {
                ...
                if (responseDto.getResponse_msg().equals("RecommendCategory_success")) {
                    ...
                    if(originalPlayObjects != null) {
                        System.out.println("RECOMMEND PREFERDTO : " + preferDtos.size());
                        System.out.println("RECOMMEND Original : " + originalPlayObjects.size());
//                        System.out.println("originalPlayObjects.get(i).getCat2() : " + originalPlayObjects.get(0).getCat2());
//                        System.out.println("originalPlayObjects.get(i).getCat2() : " + originalPlayObjects.get(0).getCat3());
//                        System.out.println("preferDtos.get(i).getCat2() : " + preferDtos.get(0).getCg_id());

                        for (int i = 0; i < originalPlayObjects.size()/10; i++) {
//                            System.out.println("originalPlayObjects.get(i).getCat2() : " + originalPlayObjects.get(i).getCat2());
//                            System.out.println("originalPlayObjects.get(i).getCat2() : " + originalPlayObjects.get(i).getCat3());

                            if(preferDtos.size() == 0) System.out.println("RECOMMEND PREFERDTO22 : " + preferDtos.size());
                            else {
...
//                                    System.out.println("preferDtos.get(i).getCat2() : " + preferDtos.get(j).getCg_id());
