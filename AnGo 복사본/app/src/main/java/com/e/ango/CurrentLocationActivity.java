...
public class CurrentLocationActivity extends AppCompatActivity
    ...
    public String currentLatitude, currentLongitdue; // 현재 위치 위도, 경도
...
//        System.out.println("ON CREATE : " + weather_type);
...
//            System.out.println("MAIN SETIMAGEDRQWABLE");
//        }
    }
    ...
    LocationCallback locationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            if (locationList.size() > 0) {
                ...
                currentLongitdue = String.valueOf(location.getLongitude());
    ...
    public String getCurrentAddress(LatLng latlng) {
        ...
        if (addresses == null || addresses.size() == 0) {
            ...
            if (flag_coordinate) {
                try {
                    originalPlayObjects = new PlayTask(currentLatitude, currentLongitdue).execute().get();
                    ...
                    if (originalPlayObjects != null && stringAddr != null) {
                        ...
                        if(weather_type != null) {
                            ...
                            System.out.println("MAIN WEATHER_TYPE : " + weather_type);
                            System.out.println("USER PREFERENCEPLAYOBJECTS 1 : " + userPreferencePlayObjects.get(0).getCat2());
                ...
                if (userPreferencePlayObjects != null) { //추천 놀거리가 존재하는 경우천
                    System.out.println("USER PREFERENCEPLAYOBJECTS 2 : " + userPreferencePlayObjects.get(0).getCat2());
                    //추천 리스트 뷰
                    ...
                    for (int i = 0; i < size; i++) {
                        ...
                        listData.summary = userPreferencePlayObjects.get(i).addr1 + " " + userPreferencePlayObjects.get(i).addr2;
            ...
            return stringAddr;//address.getAddressLine(0).toString();
