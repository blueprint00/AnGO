...
//            items.add(pob.get(i).title);
//        }
//
//        adapter = new ArrayAdapter<String>(MainActivity.this, android.R.layout.activity_list_item, items);
//
    ...
    LocationCallback locationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            if (locationList.size() > 0) {
                ...
                try {
                    new HttpAsyncTaskAir().execute(); // 미세먼지
                    new HttpAsyncTaskPlay().execute(); // 놀거리
                    String weather_type = new HttpAsyncTaskAirWeather().execute().get(); // 날씨, 온도, 타입
                    playObjects = new RecommendTask(weather_type).execute().get(); // 추천
