...
import static com.e.ango.MainActivity.iv_weatherIcon;
                ...
                switch (airWeatherObject.getIcon()) {
                    ...
                    case "Snow":
                        if (airWeatherObject.getTemperature() < 5) weatherType = "type_1";
                            iv_weatherIcon.setImageResource(R.drawable.snowflake);
                    ...
                    case "rain":
                        ...
                        iv_weatherIcon.setImageResource(R.drawable.rain);
                        break;
                    case "clear":
                    case "Clear":
                    case "clear-night":
                    case "clear-day":
                        ...
                        iv_weatherIcon.setImageResource(R.drawable.sunnyy);
                        break;
                    default: //cloudy, mostly-cloudy, wind...
                        ...
                        iv_weatherIcon.setImageResource(R.drawable.cloud);
                        break;
