...
public class SearchAreaActivity extends AppCompatActivity {
    ...
    public static String time;//시간 받아온 결과
    public static String xCoordinate;
    public static String yCoordinate;
    public static String districtResult;//사용자가 선택한 지역(api 파싱할때 지역 비교를 위해 필요)
    ...
    public static TextView textView_weatherPasredData;//날씨 파싱 데이터
