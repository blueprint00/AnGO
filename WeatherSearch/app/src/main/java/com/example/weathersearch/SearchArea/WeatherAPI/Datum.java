...
public class Datum {
    public long time;//그 날의 시간(몇 월 몇 일) 자료형 long -> double
    public String summary;
    public String icon;//그 날의 날씨 설명


    public double humidity;//습도

    public double apparentTemperatureMin;////그 날의 최저 온도

    public double apparentTemperatureMax;////그 날의 최고 온도
