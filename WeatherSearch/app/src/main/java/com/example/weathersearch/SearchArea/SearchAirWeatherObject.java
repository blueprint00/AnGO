...
public class SearchAirWeatherObject {
    ...
    public SearchAirWeatherObject(String airCityName, String aircityNameEng, String airPm25Value, String airDataTime, String airPm10Value, String airSidoName, long currentlyTime, String currentlyIcon, double currentlyTemperature, double currentlyHumidity, long dailyTime, String dailyIcon, double dailyHumidity, double dailyApparentTemperatureMax, double dailyApparentTemperatureMin) {
